...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["782777145146605611"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
• Toplam Erkek Kayıtlar: \`${erkek}\`
• Toplam Kadın Kayıtlar: \`${kadın}\``)
.setFooter(`Lively`)
